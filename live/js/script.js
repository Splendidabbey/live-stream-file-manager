  ...
  setInterval(addRandomComment('normal'), 3000); // Add random comment every 3 second
  ...
  function addRandomComment(type) {
    if (commentCount >= maxComments) {
  ...
  function checkVideoProgress() {
    ...
    if (videoProgress >= 30 && !commentButton.disabled) {
      addRandomComment('end'); // Add comments at 30% towards the end
    }
  }
